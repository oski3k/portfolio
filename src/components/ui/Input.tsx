    ...
    <div className={`group ${containerClassName}`}>
      ...
      >
        <motion.input
          ...
          } rounded-xl text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-accent/20 transition-all disabled:opacity-50 disabled:cursor-not-allowed backdrop-blur-sm ${className}`}
          {...props}
        />
      </motion.div>
